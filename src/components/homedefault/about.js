                        ...
                        <div className="inner">
                            <div className="content">
                                ...
                                <div className="button-group mt--30">
                                    {downloadButton && <a className="rn-button wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1000ms" href="https://github.com/sshhwwaa/joshuabright/blob/5a03e7078e15ac04c16d1c41a76e64da09bfdf96/src/components/homedefault/CVJoshuaBright20.2.22.pdf?raw=true" target="_blank"><span>{downloadButton}</span></a>}
                                </div>
                            </div>
                        </div>
                    </div>
