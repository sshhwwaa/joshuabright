                        ...
                        <div className="inner">
                            <div className="content">
                                ...
                                <div className="button-group mt--30">
                                    {downloadButton && <a className="rn-button wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1000ms" href="https://www.joshuabright.co.uk/JoshuaBrightCV24.01.2021.pdf" target="_blank"><span>{downloadButton}</span></a>}
                                </div>
                            </div>
                        </div>
                    </div>
