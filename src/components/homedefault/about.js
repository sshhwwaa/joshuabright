                        ...
                        <div className="inner">
                            <div className="content">
                                ...
                                <div className="button-group mt--30">
                                    {downloadButton && <a className="rn-button wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1000ms" href="https://github.com/sshhwwaa/joshuabright/blob/1dc056416000ba8e9eef0b10c2c1948b40d0458c/src/components/homedefault/CVJoshuaBright%2020.2.22.pdf?raw=true" target="_blank"><span>{downloadButton}</span></a>}
                                </div>
                            </div>
                        </div>
                    </div>
